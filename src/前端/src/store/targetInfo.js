...
export const useTargetInfoStore = defineStore('targetInfo',()=>{
    ...
    const setSenderId = (newInfo)=> {
        info.value.senderId = newInfo
    }
    ...
    return { info, setFriendId, setGroupId, setTargetName, setTargetType, setSenderId,getInfo,setLeaveMessageName,setLeaveMessageId}
