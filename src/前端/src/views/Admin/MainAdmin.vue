...
import {
  ...
  EditPen,
  SwitchButton,
  CaretBottom, Edit, ChatLineRound, ChatRound,CircleCheck,Message
  ...
  <el-container class="layout-container">
    ...
    <el-aside width="200px" >
      <div style="border:transparent">
        ...
        <div style="font-size: 40px;margin: 0 auto 10% auto;text-align: center">icechat</div>
      </div>
      ...
      <el-menu active-text-color="#ffd04b" background-color="beige"  text-color="black"
        ...
        <el-menu-item index="/admin/userchats">
          <el-icon>
            <Management />
          </el-icon>
          <span>用户聊天列表</span>
        </el-menu-item>
        <el-menu-item index="/admin/groupchats">
          <el-icon>
            <Promotion />
          </el-icon>
          <span>群组聊天列表</span>
        ...
        <el-sub-menu >
          ...
          <el-menu-item index="/admin/userResetPassword">
            <el-icon>
              <EditPen />
            </el-icon>
            <span>重置密码</span>
    ...
    <el-container class="mainViewRight" >
      ...
      <!-- 底部区域 -->
      <el-footer>Icechat ©2024 Created by ICEFJL</el-footer>
    </el-container>
  </el-container>
</template>
